        ...
        public static RegEnv Find(Reg reg, Env env)
        {
            return (reg.Abbr + env.Abbr) switch
            {
                "nd" => new RegEnv(reg, env,
                    "ndev-platform57-cluster.cluster-ro-cvk5xlkk0wai.us-east-1.rds.amazonaws.com",
                    "ndev-jobapi57-cluster.cluster-ro-cvk5xlkk0wai.us-east-1.rds.amazonaws.com",
                ...
                "nq" => new RegEnv(reg, env,
                    "nqa-platform57-cluster.cluster-ro-cvk5xlkk0wai.us-east-1.rds.amazonaws.com",
                    "nqa-jobapi57-cluster.cluster-ro-cvk5xlkk0wai.us-east-1.rds.amazonaws.com",
                ...
                "np" => new RegEnv(reg, env,
                    "nprd-platform57-cluster.cluster-ro-cupgqbweuwxq.us-east-1.rds.amazonaws.com",
                    "nprd-jobapi57-cluster.cluster-ro-cupgqbweuwxq.us-east-1.rds.amazonaws.com",
                ...
                "nh" => new RegEnv(reg, env,
                    "nhip-platform57-cluster.cluster-ro-cwsi0wy5x6bo.us-east-1.rds.amazonaws.com",
                    "nhip-jobapi57-cluster.cluster-ro-cwsi0wy5x6bo.us-east-1.rds.amazonaws.com",
                ...
                "id" => new RegEnv(reg, env,
                    "idev-platform57-cluster.cluster-ro-cu0vdzawgxcv.eu-west-1.rds.amazonaws.com",
                    "idev-jobapi57-cluster.cluster-ro-cu0vdzawgxcv.eu-west-1.rds.amazonaws.com",
                ...
                "iq" => new RegEnv(reg, env,
                    "iqa-platform57-cluster.cluster-ro-cu0vdzawgxcv.eu-west-1.rds.amazonaws.com",
                    "iqa-jobapi57-cluster.cluster-ro-cu0vdzawgxcv.eu-west-1.rds.amazonaws.com",
                ...
                "ip" => new RegEnv(reg, env,
                    "iprd-platform57-cluster.cluster-ro-chs0zssn3i0f.eu-west-1.rds.amazonaws.com",
                    "iprd-jobapi57-cluster.cluster-ro-chs0zssn3i0f.eu-west-1.rds.amazonaws.com",
                ...
                "ap" => new RegEnv(reg, env,
                    "aprd-platform57-cluster.cluster-ro-csfctrvrswmu.ap-southeast-2.rds.amazonaws.com",
                    "aprd-jobapi57-cluster.cluster-ro-csfctrvrswmu.ap-southeast-2.rds.amazonaws.com",
